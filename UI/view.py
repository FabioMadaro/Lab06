...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        pulsante_mostra_auto = ft.ElevatedButton(text = "cerca", on_click=self.controller.mostra_auto)
        pulsante_cerca_auto = ft.ElevatedButton(text = "Cerca", on_click=self.controller.cerca_auto_per_modello)
        ...
        self.page.add(
            ...
            # Sezione 3
            # TODO
            ft.Row([ft.Text("Automobili", size = 18), pulsante_mostra_auto]),
